    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6" style="background-color: cornflowerblue; margin-bottom: 30px">
                    ...
                    <form action="{{ route('order.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="submit" class="btn btn-success" value="Order Submit" name="Order Place">
